...
int GetChannels(Format format) {
    ...
    case Astc4x4SfloatBlockEXT:
    case Astc5x4SfloatBlockEXT:
    case Astc5x5SfloatBlockEXT:
    case Astc6x5SfloatBlockEXT:
    case Astc6x6SfloatBlockEXT:
    case Astc8x5SfloatBlockEXT:
    case Astc8x6SfloatBlockEXT:
    case Astc8x8SfloatBlockEXT:
    case Astc10x5SfloatBlockEXT:
    case Astc10x6SfloatBlockEXT:
    case Astc10x8SfloatBlockEXT:
    case Astc10x10SfloatBlockEXT:
    case Astc12x12SfloatBlockEXT:
        return 4;
        
    case G8B8R82Plane444UnormEXT:
    case G10X6B10X6R10X62Plane444Unorm3Pack16EXT:
    case G12X4B12X4R12X42Plane444Unorm3Pack16EXT:
    case G16B16R162Plane444UnormEXT:
        return 3;
    case A4R4G4B4UnormPack16EXT:
    case A4B4G4R4UnormPack16EXT:
        return 4;
    default:
        return 0;
    } 
